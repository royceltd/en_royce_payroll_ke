...
from royce_payroll_ke.kenya_payroll.report_utils import card_type_sums_by_employee
...
def execute(filters=None):
	...
	# 6.7) — so the return declares it from Kenya Payroll Rates directly, not from a
